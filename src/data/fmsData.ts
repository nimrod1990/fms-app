  ...
  categories: [
    {
      ...
      method: '双脚与肩同宽，手臂举杆过头顶，深蹲至最低点，保持躯干与小腿平行。',
      scores: [
        {
          score: 3,
          criteria: 'a. 杆与双足平行于正上方或更后方；b. 躯干与小腿平行或垂直与地面；c. 下蹲时大腿低于水平线；d. 保持膝与足尖方向一致。',
          details: '表现良好，躯干与小腿平行，膝盖与脚尖对齐，显示出良好的下肢灵活性和核心稳定性。',
          images: ['/images/DM_20241026073914_001.PNG', '/images/DM_20241026073914_002.PNG'],
        },
        {
          score: 2,
          criteria: 'a、b、c、d之一不能达标，但仍能完成动作；或在足跟下加踮木板的前提下能顺利完成动作。',
          details: '脚跟被动抬高，动作与3分相同，但仍存在轻微的灵活性不足。',
          images: ['/images/DM_20241026073914_003.PNG', '/images/DM_20241026073914_004.PNG'],
        },
        {
          score: 1,
          criteria: 'a、b、c、d中2个以上要求不能达标，或在足跟下加踮木板的前提下也不能完成动作。',
          details: '脚跟被动抬高，动作存在重大功能障碍，建议进行髋关节和踝关节的灵活性训练。',
    ...
    },
    {
      ...
      purpose: '评估下肢的灵活性和核心稳定性。',
      method: '站立在木板旁，一脚前踏，保持双脚在同一矢状面上，进行弓箭步动作。',
      scores: [
        {
          score: 3,
    ...
    },
    {
      ...
      method: '运动员双手置于背后，尝试在不移动身体的情况下尽可能使双手相互靠近。',
      scores: [
        {
          score: 3,
      ...
      clearing_test: {
        purpose: '排除肩峰撞击问题，以确保肩部灵活性测试的准确性。',
        method: '运动员将手掌放在对侧肩上，保持与肩的接触，尽可能高地上抬肘部。',
    ...
    },
    {
      ...
      clearing_test: {
        ...
        method:
          '从俯撑姿势开始撑起上体，使脊柱充分伸展，观察是否有疼痛或不适。',

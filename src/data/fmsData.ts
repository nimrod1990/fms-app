  ...
  categories: [
    ...
    },
    {
      ...
      scores: [
        {
          score: 3,
          criteria: '保持杠杆接触，无躯干运动，膝盖触碰脚跟后的板子。',
        },
        {
          score: 2,
    ...
    },
    {
      ...
      clearing_test:
        '肩夹击测试：受试者将手臂置于肩后，用另一只手触碰对侧肩胛骨，若此动作引发疼痛，得分为0分。',
    },
    {
    ...
    },
    {
      ...
      scores: [
        {
          score: 3,
          criteria:
            '身体整体抬起，脊柱没有滞后，拇指与头顶（男性）或下巴（女性）对齐。',
        },
        {
          score: 2,
          criteria:
      ...
      clearing_test:
        '脊柱伸展清除测试：受试者跪姿，臀部后坐，上身向下压，若此动作引发疼痛，得分为0分。',
    },
    {
      ...
      clearing_test:
        '脊柱屈曲清除测试：通过伏地挺身观察脊柱屈曲是否引发疼痛，若有疼痛，得分为0分。',
    },
  ],
};
